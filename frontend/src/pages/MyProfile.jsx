  ...
  return (
    <div className='max-w-lg flex flex-col gap-2 text-sm'>
      ...
      <div className='mt-10'>
        {
          isEdit
          ? <button className='border border-[#6366f1] px-8 py-2 rounded-full hover:bg-indigo-700 hover:text-white transition-all cursor-pointer' onClick={()=>setIsEdit(false)}>Save information</button>
